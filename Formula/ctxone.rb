...
#   https://github.com/ctxone/ctxone-docs/releases/download/v0.75.1/ctxone-v0.75.1-aarch64-apple-darwin.tar.gz      — macOS arm64 tarball URL
#   7a112451a2d2b21ee498ea88ac1fde083177acc91620d17c67275200bd97bad5      — macOS arm64 tarball sha256
#   https://github.com/ctxone/ctxone-docs/releases/download/v0.75.1/ctxone-v0.75.1-x86_64-apple-darwin.tar.gz     — macOS x86_64 tarball URL
#   f0be5877cc72fdfe290167c0107bb00640785f41358e5fbf23e0f439bd9bc15e     — macOS x86_64 tarball sha256
#   https://github.com/ctxone/ctxone-docs/releases/download/v0.75.1/ctxone-v0.75.1-x86_64-unknown-linux-gnu.tar.gz      — Linux x86_64 tarball URL
#   41bad1493c6b1c05a0287f3680bd12c127da34da89699d115a260408ea79f191      — Linux x86_64 tarball sha256
#   https://github.com/ctxone/ctxone-docs/releases/download/v0.75.1/ctxone-v0.75.1-aarch64-unknown-linux-gnu.tar.gz       — Linux arm64 tarball URL
...
class Ctxone < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/ctxone/ctxone-docs/releases/download/v0.75.1/ctxone-v0.75.1-aarch64-apple-darwin.tar.gz"
      sha256 "7a112451a2d2b21ee498ea88ac1fde083177acc91620d17c67275200bd97bad5"
    end
    on_intel do
      url "https://github.com/ctxone/ctxone-docs/releases/download/v0.75.1/ctxone-v0.75.1-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/ctxone/ctxone-docs/releases/download/v0.75.1/ctxone-v0.75.1-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "41bad1493c6b1c05a0287f3680bd12c127da34da89699d115a260408ea79f191"
    end
    on_arm do
      url "https://github.com/ctxone/ctxone-docs/releases/download/v0.75.1/ctxone-v0.75.1-aarch64-unknown-linux-gnu.tar.gz"
